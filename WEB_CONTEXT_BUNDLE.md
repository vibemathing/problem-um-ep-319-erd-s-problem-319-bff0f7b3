...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-319-erd-s-problem-319-bff0f7b3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-319"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-319-erd-s-problem-319-bff0f7b3-v1",
      "problem_contract_sha256": "14f8e1186a900c272c8e52fc6525de0585fca8c344d844d3851df23f4e45f9fd",
      "problem_id": "problem:um-ep-319-erd-s-problem-319-bff0f7b3",
      "route_id": "route:um-ep-319-erd-s-problem-319-bff0f7b3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-319-erd-s-problem-319-bff0f7b3-source-fidelity-01",
      "graph_id": "graph:um-ep-319-erd-s-problem-319-bff0f7b3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-319-erd-s-problem-319-bff0f7b3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-319-erd-s-problem-319-bff0f7b3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the size of the largest $A\\subseteq \\{1,\\ldots,N\\}$ such that there is a function $\\delta:A\\to \\{-1,1\\}$ such that $ \\sum_{n\\in A}\\frac{\\delta_n}{n}=0 $ and $ \\sum_{n\\in A'}\\frac{\\delta_n}{n} eq 0 $ for all non-empty $A'\\subsetneq A$?"
          },
          "statement_sha256": "a507c20d5934a08c20644fc2aab1e38042d163d7f7c23536cfdc9cd59a0831e1"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-319-erd-s-problem-319-bff0f7b3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-319-erd-s-problem-319-bff0f7b3-root",
      "route_id": "route:um-ep-319-erd-s-problem-319-bff0f7b3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-319-2ad9bb851bd9",
        "url": "https://www.unsolvedmath.com/problems/EP-319"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
